...
function mudarImgLocation() {
    document.getElementById('img-location').src = "../global-images/location-yellow.png"
}
...
function mudarImgPlaces() {
    document.getElementById('img-places').src = "../global-images/places-yellow.png"
}

function mudarImgUser() {
    document.getElementById('img-user').src = "../global-images/section-user-yellow.png"
}
