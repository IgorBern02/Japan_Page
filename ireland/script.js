...
var el2 = document.querySelector('#ireland');
var text2 = 'Ireland'
var interval = 300;
...
function mudarImgLocation() {
    document.getElementById('img-location').src = "../global-images/location-orange.png"
}
...
function mudarImgPlaces() {
    document.getElementById('img-places').src = "../global-images/places-orange.png"
}

function mudarImgUser() {
    document.getElementById('img-user').src = "../global-images/section-user-orange.png"
}
